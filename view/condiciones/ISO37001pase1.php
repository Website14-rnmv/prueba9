...
$_SESSION["preguntas"]["pregunta_5"] = $_POST["pregunta_5"];/*RECIBIDO */
$_SESSION["preguntas"]["pregunta_6"] = $_POST["pregunta_6"];/*RECIBIDO */
$_SESSION["preguntas"]["pregunta_7"] = $_POST["pregunta_7"];/*RECIBIDO */
$_SESSION["preguntas"]["pregunta_8"] = $_POST["pregunta_8"];/*RECIBIDO */

$pre8 = $_SESSION["preguntas"]["pregunta_8"];/*RECIBIDO */
...
<body>
    <?php
    /*PASAR A RESPONDER 3 PREGUNTAS MAS */
    ...
    ?>
        ...
        <main>
            <section class="content-bloques">
                ...
                <form class="bloque-2" action="../condiciones/redircondi9.php" method="POST">

                    <!-- PREGUNTA NUMERO PREGUNTA 8 CONDICION 1------------------------------------------------------------------------------------------>
                    <div class="pregunta ">
                        <div class="content-pre">
                            <h1>¿Se encuentra documentada?</h1>
                            <div class="wrapper">
                                <input type="radio"  name="pregunta_8_1" value="si" id="option-1" required>
                                <input type="radio"  name="pregunta_8_1" value="no" id="option-2" required>
                    ...
                    <!-- PREGUNTA NUMERO  PREGUNTA 8 CONDICION 2------------MODULO 2------------------------------------------------------------------------------>
                    <div id="section2"></div>
                    <div class="pregunta">
                        <div class="content-pre">
                            <h1>¿Se comunicó dentro de la organización?</h1>
                            <div class="wrapper">
                                <input type="radio" name="pregunta_8_2" value="si" id="option-3" required>
                                <input type="radio" name="pregunta_8_2" value="no" id="option-4" required>
                    ...
                    <!-- PREGUNTA NUMERO  PREGUNTA 8 CONDICION 3--------------MODULO 2---------------------------------------------------------------------------->
                    <div id="section3"></div>
                    <div class="pregunta">
                        <div class="content-pre">
                            <h1>¿Es accesible a las partes interesadas?</h1>
                            <div class="wrapper">
                                <input type="radio" name="pregunta_8_3" value="si" id="option-5" required>
                                <input type="radio" name="pregunta_8_3" value="no" id="option-6" required>
    ...
    ?>
        ...
        <main>
            <section class="content-bloques">
                ...
                <form class="bloque-2" action="../condiciones/condicion9_2.php" method="POST">

                    <!-- PREGUNTA NUMERO PREGUNTA 9 CONDICION 1--SI ES NO MOSTRAR LA OTRA PREGUNTA---------------------------------------------------------------------------------------->
                    <div class="pregunta ">
                        <div class="content-pre">
                            <h1>¿Se han establecido los roles y responsabilidades dentro de la organización?</h1>
                            <div class="wrapper">
                                <input type="radio" name="pregunta_9" value="si" id="option-1" required>
                                <input type="radio" name="pregunta_9" value="no" id="option-2" required>
                                <label for="option-1" class="option option-1">
                                    <div class="dot"></div>
                                    <span>Si</span>
                                </label>
                        ...
                        <div class="flechas">
                            <input title="Siguiente Modulo" class="modulo-siguiente" type="submit" value="Siguiente"  class="down fas fa-chevron-down">
                        </div>
                    </div>
                    <!-- PREGUNTA NUMERO PREGUNTA 9 CONDICION 1----------------------------------------------------------------------------------------->

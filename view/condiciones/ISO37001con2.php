...
$_SESSION["preguntas"]["pregunta_8"] = $_POST["pregunta_8"]; */
    ...
    $c = $_POST["pregunta_8_1"];/*RECIBIDO */
    $b= $_POST["pregunta_8_2"];/*RECIBIDO */
    $a = $_POST["pregunta_8_3"];/*RECIBIDO */

echo $c;

/*CONDICION */
$_SESSION["preguntas"]["pregunta_9"] = $_POST["pregunta_9"];/*RECIBIDO */
/*CONDICION */

$pre9 = $_SESSION["preguntas"]["pregunta_9"];
...
<body>
    <?php
    /*PASAR A RESPONDER 1 PREGUNTAS MAS */

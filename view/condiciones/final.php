...
$_SESSION["preguntas"]["pregunta_31"] = $_POST["pregunta_31"];
$_SESSION["preguntas"]["pregunta_32"] = $_POST["pregunta_32"];
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <section class="content-bloques">
            <section class="bloque-1">
                ...
                <i class="fas fa-user-cog"></i>
                    <h2 class="">Operación</h2>
                </div>

                <div class="modulos block-1">
                <i class="fas fa-exclamation-triangle"></i>
                    <h2 class="">Evaluación del desempeño</h2>
                </div>
                ...
                <div class="modulos">
                <i class=" active fas fa-check-circle"></i>
                    <h2 class="active">Resultado</h2>
                </div>
            </section>

            <form class="bloque-2" action="../condiciones/resultado.php" method="POST">

                <!-- PREGUNTA NUMERO PREGUNTA 31  MODULO 7------------------------------------------------------------------------------------------>
                <div class="pregunta ">
                    <div class="content-pre">
                        <h1>¡Has terminado el test de preguntas!</h1>
                        
                        <a class="resultado" href="resultado.php">Ver Resultado</a>

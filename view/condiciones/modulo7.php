<?php
session_start();
$_SESSION["preguntas"]["pregunta_28"] = $_POST["pregunta_28"];
$_SESSION["preguntas"]["pregunta_29"] = $_POST["pregunta_29"];
$_SESSION["preguntas"]["pregunta_30"] = $_POST["pregunta_30"];
...
<main>
    <section class="content-bloques">
        <section class="bloque-1">
            ...
            <div class="modulos block-1">
            <i class="modulo_pasado fas fa-exclamation-triangle"></i>
                <h2 class="modulo_pasado">Evaluación del desempeño</h2>
            </div>

            <div class="modulos">
            <i class="active fas fa-signal"></i>
                <h2 class="active">Mejora</h2>
            </div>
        ...
        <form class="bloque-2" action="../condiciones/final.php" method="POST">

            <!-- PREGUNTA NUMERO PREGUNTA 31  MODULO 7------------------------------------------------------------------------------------------>
            <div class="pregunta ">
                <div class="content-pre">
                    <h1>¿La organización ha implementado mecanismos para la gestión de no conformidades y las acciones correctivas relacionadas? </h1>
                    <div class="wrapper">
                        <input type="radio" name="pregunta_31" value="si" id="option-1" required>
                        <input type="radio" name="pregunta_31" value="no" id="option-2" required>
            ...
            <div id="section2"></div>
            <!-- PREGUNTA NUMERO PREGUNTA 32  MODULO 7------------------------------------------------------------------------------------------>
            <div class="pregunta ">
                <div class="content-pre">
                    <h1>¿La organización ha determinado cómo mejorar su Sistema de Gestión Antisoborno?</h1>
                    <div class="wrapper">
                        <input type="radio" name="pregunta_32" value="si" id="option-3" required>
                        <input type="radio" name="pregunta_32" value="no" id="option-4" required>

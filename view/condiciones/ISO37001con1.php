<?php
session_start();
$_SESSION["preguntas"]["pregunta_1"] = $_POST["pregunta_1"];/*RECIBIDO */
$_SESSION["preguntas"]["pregunta_2"] = $_POST["pregunta_2"];/*RECIBIDO */
$_SESSION["preguntas"]["pregunta_3"] = $_POST["pregunta_3"];/*RECIBIDO */
$_SESSION["preguntas"]["pregunta_4"] = $_POST["pregunta_4"];/*RECIBIDO */
...
<body>
    ...
    <main>
        <section class="content-bloques">
            ...
            <form class="bloque-2" action="../condiciones/ISO37001pase1.php" method="POST">

                <!-- PREGUNTA NUMERO 5----------MODULO 2--------------------------------------------------------------------------------->
                <div class="pregunta ">
                    <div class="content-pre">
                        <h1>¿La organización cuenta con un órgano de gobierno, junta de directores o accionistas?</h1>
                        <div class="wrapper">
                            <input type="radio" name="pregunta_5" value="si" id="option-1" required>
                            <input type="radio" name="pregunta_5" value="no" id="option-2" required>
                    ...
                    <div class="flechas">
                    <!-- <a title="Regresar" href="../../view/ISO37001view/ISO37001pre.php" class="down fas fa-chevron-up"></a> -->

                        <a title="Siguiente" href="#section2" class="down fas fa-chevron-down"></a>
                    </div>
                </div>
                <!-- PREGUNTA NUMERO 5----------MODULO 2-------------------------------------------------------------------------------->

                <!-- PREGUNTA NUMERO 6-----------MODULO 2------------------------------------------------------------------------------->
                <div id="section2"></div>
                <div class="pregunta ">
                    <div class="content-pre">
                        <h1>¿La organización ha asignado al encargado de la función de Cumplimento en la organización? </h1>
                        <div class="wrapper">
                            <input type="radio" name="pregunta_6" value="si" id="option-3" required>
                            <input type="radio" name="pregunta_6" value="no" id="option-4" required>
                    ...
                    <div class="flechas">
                        <a title="Siguiente" href="#section1" class="down fas fa-chevron-up"></a>
                ...
                <!-- PREGUNTA NUMERO 7-----------MODULO 2------------------------------------------------------------------------------->
                <div id="section3"></div>
                <div class="pregunta ">
                    <div class="content-pre">
                        <h1>¿La organización ha asignado al encargado de la función de Cumplimento en la organización? </h1>
                        <div class="wrapper">
                            <input type="radio" name="pregunta_7" value="si" id="option-5" required>
                            <input type="radio" name="pregunta_7" value="no" id="option-6" required>
                    ...
                    <div class="flechas">
                        <a title="Siguiente" href="#section2" class="down fas fa-chevron-up"></a>
                ...
                <!-- PREGUNTA NUMERO 8----------------CONDICIONAL-----MODULO 2--------------------------------------------------------------------->
                <div id="section4"></div>

                <div class="pregunta ">
                    <div class="content-pre">
                        <h1>¿Se ha establecido una politica antisoborno?</h1>
                        <div class="wrapper">
                            <input type="radio" name="pregunta_8" value="si" id="option-7" required>
                            <input type="radio" name="pregunta_8" value="no" id="option-8" required>

    ...
    ?>
        ...
        <main>
            ...
            <section class="bloque-1">
                ...
                <form class="bloque-2" action="../condiciones/recibir11_1.php" method="POST">

                    <!-- PREGUNTA NUMERO PREGUNTA 11_1 CONDICION 1------------------------------------------------------------------------------------------>
                    <div class="pregunta ">
                    ...
                    <!-- PREGUNTA NUMERO PREGUNTA 11_1------------MODULO 3----------------------------------------------------------------------------->
        ...
        <main>
            <section class="content-bloques">
                <section class="bloque-1">
                    ...
                    <div class="modulos">
                        <i class="active fas fa-chart-line"></i>
                        <h2 class="active">Apoyo</h2>
                    </div>
                ...
                <form class="bloque-2" action="../condiciones/recibir12_17mod4.php" method="POST">

<?php
session_start();
$_SESSION["preguntas"]["pregunta_18"] = $_POST["pregunta_18"];
$_SESSION["preguntas"]["pregunta_19"] = $_POST["pregunta_19"];
$_SESSION["preguntas"]["pregunta_20"] = $_POST["pregunta_20"];
$_SESSION["preguntas"]["pregunta_21"] = $_POST["pregunta_21"];
$_SESSION["preguntas"]["pregunta_22"] = $_POST["pregunta_22"];
$_SESSION["preguntas"]["pregunta_23"] = $_POST["pregunta_23"];
$_SESSION["preguntas"]["pregunta_24"] = $_POST["pregunta_24"];
$_SESSION["preguntas"]["pregunta_25"] = $_POST["pregunta_25"];
$_SESSION["preguntas"]["pregunta_26"] = $_POST["pregunta_26"];
$_SESSION["preguntas"]["pregunta_27"] = $_POST["pregunta_27"];
...
/*ALMACENAMOS LOSD ATOS DE LAS PREGUNTAS 12 13 14 15*/
...
echo "<br>". "pregunta repuesta 11: ". $_SESSION["preguntas"]["pregunta_11_1"];
...
<main>
    <section class="content-bloques">
        <section class="bloque-1">
            ...
            <div class="modulos block-1">
                <i class=" modulo_pasadofas fa-chart-line"></i>
                <h2 class="modulo_pasado">Apoyo</h2>
            </div>

            <div class="modulos block-1">
            <i class=" modulo_pasado fas fa-user-cog"></i>
                <h2 class="modulo_pasado ">Operación</h2>
            </div>

            <div class="modulos ">
            <i class="active fas fa-exclamation-triangle"></i>
                <h2 class="active">Evaluación del desempeño</h2>
            </div>
        ...
        <form class="bloque-2" action="../condiciones/modulo7.php" method="POST">

            <!-- PREGUNTA NUMERO PREGUNTA 28  MODULO 6------------------------------------------------------------------------------------------>
            <div class="pregunta ">
                <div class="content-pre">
                    <h1>¿Se han determinado los métodos, criterios y frecuencias del monitoreo hacia el Sistema de Gestion Antisoborno? </h1>
                    <div class="wrapper">
                        <input type="radio" name="pregunta_28" value="si" id="option-1" required>
                        <input type="radio" name="pregunta_28" value="no" id="option-2" required>
            ...
            <!-- PREGUNTA NUMERO PREGUNTA 28 CON CONCDICION------------MODULO 6----------------------------------------------------------------------------->


            <div id="section2"></div>
            <!-- PREGUNTA NUMERO PREGUNTA 29  MODULO 6------------------------------------------------------------------------------------------>
            <div class="pregunta ">
                <div class="content-pre">
                    <h1>¿La organización llevó a acabo auditorias internas a intervalos planificados para confirmar que el Sistema de Gestión Antisoborno cumple con los requisitos de la norma?</h1>
                    <div class="wrapper">
                        <input type="radio" name="pregunta_29" value="si" id="option-3" required>
                        <input type="radio" name="pregunta_29" value="no" id="option-4" required>
            ...
            <!-- PREGUNTA NUMERO 30--------------------------------------MODULO 6---------------------------------------------------->
            <div id="section3"></div>
            <div class="pregunta">
                <div class="content-pre">
                    <h1>¿La organización ha realizado la Revisión por la Direccion para asegurar la eficacia del Sistema de Gestion Antisoborno?</h1>
                    <div class="wrapper">
                        <input type="radio" name="pregunta_30" value="si" id="option-5" required>
                        <input type="radio" name="pregunta_30" value="no" id="option-6" required>

        ...
        <section class="content-bloques">
            <section class="bloque-1">
                ...
                <div class="modulos block-1">
                    <i class="active fas fa-landmark"></i>
                    <h2 class="active">Contexto de la organización</h2>
                </div>
            ...
            <form class="bloque-2" action="../condiciones/ISO37001con1.php" method="POST">

                <!-- PREGUNTA NUMERO 1------------------------------------------------------------------------------------------>
                <div class="pregunta ">
                    <div class="content-pre">
                        <h1>¿La organización ha determinado las cuestiones internas y externas pertinentes a la organización?</h1>
                        <div class="wrapper">
                            <input type="radio" name="pregunta_1" value="si" id="option-1" required>
                            <input type="radio" name="pregunta_1" value="no" id="option-2" required>
                ...
                <div class="pregunta">
                    <div class="content-pre">
                        <h1>¿La organización dispone de un procedimiento/mecanismo para la identificacion de las partes interesadas para el Sistema de Gestion Antisoborno?</h1>
                        <div class="wrapper">
                            <input type="radio" name="pregunta_2" value="si" id="option-3" required>
                            <input type="radio" name="pregunta_2" value="no" id="option-4" required>
                ...
                <div class="pregunta">
                    <div class="content-pre">
                        <h1>¿Se ha determinado el alcance del Sistema de Gestion Antisoborno de la organización?</h1>
                        <div class="wrapper">
                            <input type="radio" name="pregunta_3" value="si" id="option-5" required>
                            <input type="radio" name="pregunta_3" value="no" id="option-6" required>
                ...
                <div class="pregunta">
                    <div class="content-pre">
                        <h1>¿La organización ha determinado los riesgos y oportunidades que deben ser abordados para lograr los resultados del Sistema de Gestion Antisoborno?</h1>
                        <div class="wrapper">
                            <input type="radio" name="pregunta_4" value="si" id="option-7" required>
                            <input type="radio" name="pregunta_4" value="no" id="option-8" required>
                    ...
                    <div class="flechas">
                        ...
                        <input title="Siguiente Modulo" class="modulo-siguiente" type="submit" value="Siguiente" name="siguiente-modulo" class="down fas fa-chevron-down">
                    </div>
                </div>
                <!-- PREGUNTA NUMERO 4------------------------------------------------------------------------------------------>
